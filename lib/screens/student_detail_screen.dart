...
class _StudentDetailScreenState extends State<StudentDetailScreen> {
                ...
                children: [
                  ...
                  if (isLoading)
                    Padding(
                      ...
                      child: Center(
                        child: CircularProgressIndicator(color: const Color(0xFF03A9F4)),
                      ),
                    )
                  else if (error != null)
                    Padding(
                      ...
                      child: _buildGlassCard(
                        ...
                        children: [
                          Text('Failed to load data: $error', style: TextStyle(color: Colors.red)),
                        ],
                      ),
                    )
    ...
    for (final semester in componentData!.semesters) {
      ...
      widgets.add(_buildGlassCard(
        ...
        children: [
          ...
          ...semester.subjects.map((subject) => _buildSubjectCard(context, subject)).toList(),
        ],
      ));
    }
  ...
  TableRow _buildComponentRow(BuildContext context, String name, int? marks, int? weightage, TextStyle style) {
    return TableRow(
      children: [
        Padding(
          padding: const EdgeInsets.all(4),
        ...
        Padding(
          padding: const EdgeInsets.all(4),
          child: Text(marks != null ? marks.toString() : '-', style: style, textAlign: TextAlign.center),
        ),
        Padding(
          padding: const EdgeInsets.all(4),
          child: Text(weightage != null ? weightage.toString() : '-', style: style, textAlign: TextAlign.center),
        ),
      ],
    );
  }
