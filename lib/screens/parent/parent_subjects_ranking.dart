...
class ParentSubjectsRankingScreen extends StatefulWidget {
  ...
  @override
  State<ParentSubjectsRankingScreen> createState() => _ParentSubjectsRankingScreenState();
}
...
class _ParentSubjectsRankingScreenState extends State<ParentSubjectsRankingScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchStudentData() async {
    try {
      ...
      // Use a hardcoded email for testing - you can modify this to get from parent's child data
      const email = "ritesh.sanchla115960@marwadiuniversity.ac.in";
      ...
      print('API response received: ${'success'}');
